...
print(counter)
    ...
    """Changing the value of a variable: Python variable are dynamicall typed
    and not subject to the data type restriction. A variable may be assigned to 
    a value of one type, and then we can re-assigned a value of a different type
    """